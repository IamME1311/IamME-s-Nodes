...
app.registerExtension({
    // registering js file to comfy extensions folder
	...
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
        ...
        if (nodeData.name === "MultiLatentComposite") {
			...
			nodeType.prototype.onNodeCreated = function () {
                ...
                // widgets of the node itself, not of the input_connected nodes
                // modify this according to the image blend node widgets
                // can remove this as these lines are used to add widgets to the nodes, our case has widgets already added
